...
frame1 = Frame(root)
frame1.pack()
titleLabel = Label(frame1,text="Tic Tac Toe",font=("Arial", 26),bg="#669966",width=12)
...
def restartGame():
  ...
  titleLabel = Label(frame1,text="Tic Tac Toe",font=("Arial", 30),bg="#669966",width=12)
  titleLabel.grid(row=0, column=0)
...
def play(event):
  ...
  if button["text"] == " ":
    if turn == "x":
      board[clicked] = turn
      if checkForWin(turn):
        winningLabel = Label(frame1,text=f"{turn} wins the game",bg="#669966",font=("Arial", 26), width=12)
      ...
      if mode == "singlePlayer":
        ...
        if checkForWin(turn):
          winningLabel = Label(frame1,text=f"computer-wins",bg="#669966",font=("Arial", 26),width=12)
          winningLabel.grid(row=0, column=0, columnspan=3)
          game_end = True
    ...
    if checkForDraw():
      drawLabel = Label(frame1,text=f"Game Draw",bg="#669966",font=("Arial", 26), width=10)
...
button1 = Button(frame2,text=" ",width=4,height=2,font=("Arial", 30),bg="#ff9999",relief=RAISED,borderwidth=5)
button1.grid(row=0, column=0)
button1.bind("<Button-1>", play)

button2 = Button(frame2,text=" ",width=4,height=2,font=("Arial", 30),bg="#ff9999",relief=RAISED,borderwidth=5)
button2.grid(row=0, column=1)
button2.bind("<Button-1>", play)

button3 = Button(frame2,text=" ",width=4,height=2,font=("Arial", 30),bg="#ff9999",relief=RAISED,borderwidth=5)
button3.grid(row=0, column=2)
button3.bind("<Button-1>", play)

#  second row

button4 = Button(frame2, text=" ", width=4, height=2, font=("Arial", 30), bg="#ff9999", relief=RAISED, borderwidth=5)
button4.grid(row=1, column=0)
button4.bind("<Button-1>", play)

button5 = Button(frame2,text=" ",width=4,height=2,font=("Arial", 30),bg="#ff9999",relief=RAISED,borderwidth=5)
button5.grid(row=1, column=1)
button5.bind("<Button-1>", play)

button6 = Button(frame2,text=" ",width=4,height=2,font=("Arial", 30),bg="#ff9999",relief=RAISED,borderwidth=5)
button6.grid(row=1, column=2)
button6.bind("<Button-1>", play)

#  third row

button7 = Button(frame2,text=" ",width=4,height=2,font=("Arial", 30),bg="#ff9999",relief=RAISED,borderwidth=5)
button7.grid(row=2, column=0)
button7.bind("<Button-1>", play)

button8 = Button(frame2,text=" ",width=4,height=2,font=("Arial", 30),bg="#ff9999",relief=RAISED,borderwidth=5)
button8.grid(row=2, column=1)
button8.bind("<Button-1>", play)

button9 = Button(frame2,text=" ", width=4,height=2, font=("Arial", 30), bg="#ff9999", relief=RAISED, borderwidth=5)
